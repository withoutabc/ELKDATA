...
本项目所展示的可视化图表均已单独保存于`ELKDATA/docs/dashboard/`目录下。
...
- 复杂性：共有**2000+**条数据。![](./docs/images/datasource1.png)
...
以上信息和图表**都能够实时动态收集信息并绘图**，这是由`logstash`**实时收集信息**的特性决定的。若评委老师访问http://49.7.114.49:5888/visit后想观测自己的访问记录是否被收集，可以打开http://49.7.114.49:5601/app/dashboards#/view/a2381460-545d-11ee-a0a4-237297b5e6c4此界面。**如果不能正常打开请无视，部署不太稳定**。
